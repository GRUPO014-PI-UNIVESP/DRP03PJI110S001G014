<?php
    // Programa      : P13GQualidade.php
    // Funcionalidade: seletor para tarefas de laboratório de controle de qualidade 
...
<body>
  ...
  <div class="sidebarBottom">
    ...
    <!-- Área Principal -->
    <div class="main">
      <p style="text-align: center; font-size: 30px">Garantia da Qualidade</p>

      <!-- Botões Seletores -->
      <div class="frame">       
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Abertura de Ordem de Serviço</span></button>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Cadastro de Nova Amostra</span></button><br><br>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Registro de Análises</span></button>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Cadastro de Novo Reagente</span></button><br><br>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Reposição do Estoque de Reagentes</span></button>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Retirada de Reagente do Estoque</span></button><br><br>

        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Listas e Relatórios Laboratoriais</span></button>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span></span></button><br><br>   
      </div>
    </div>
</body>
</html>