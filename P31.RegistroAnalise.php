...
<body>
    <div class="main">
        <div class="principal">
            <form action="P32.RegistroAnalise.php" method="POST">        
                <div class="pLinha1L">
                    <br>
                    <div class="inputBox">
            ...
            <div class="pLinha1R">
                <br>
                <input class="b2" type="reset" value="Voltar" id="botao" style="text-align:center" onclick="location.href='P20.MenuGQ.php'">
            </div>
        </div>
        <div class="tabela1">
