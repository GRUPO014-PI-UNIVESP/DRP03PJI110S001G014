<?php
    ...
    $sqlFinal = "SELECT * FROM ordem_servico WHERE SITUACAO = 'CONCLUÍDO' ORDER BY DATA_CONCLUSAO DESC";
    $listaFinal = $conectDB->query($sqlFinal) or die();
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<body>
    <div class="mainBox">
        ...
        <br><br>
        <p style="text-align:center; font-size:16px; ">Lista de Análises Concluídas</p>
        <table >
            <thead>
                <tr>
                    ...
                    <th style="width: 120px; font-size: 12px; ">Responsável</th>
                    <th style="width: 100px; font-size: 12px; ">Data da Finalização</th>
                </tr>
            </thead>
            <tbody>
                <?php while($dado4 = $listaFinal->fetch_array()) { ?> 
                <tr>
                    <td style="font-size: 12px; width: 100px; height: 30px; text-align:center;"> <?php echo $dado4['CODIGO_AMOSTRA'];?> </td> 
                    <td style="font-size: 12px; width: 590px; height: 30px;"                   > <?php echo $dado4['DESCRICAO_AMOSTRA']; ?> </td>
                    <td style="font-size: 12px; width: 100px; height: 30px; text-align:center;"> <?php echo $dado4['NUMERO_LOTE'];?> </td>
                    <td style="font-size: 12px; width: 120px; height: 30px; text-align:center;"> <?php echo $dado4['RESPONSAVEL'];?> </td>
                    <td style="font-size: 12px; width: 100px; height: 30px; text-align:center;"> <?php echo $dado4['DATA_CONCLUSAO'];?> </td>
                </tr> 
                <?php } ?>
            </tbody>
        </table>
