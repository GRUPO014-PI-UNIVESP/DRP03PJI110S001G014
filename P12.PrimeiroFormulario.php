...
<body>
    <div class="mainBox">
        <fieldset>
            ...
            <form action="P12.VerificaNome.php" method="POST">
                <div class="box1esq">
                    <label style="font-size:13px;"for="nascimento">Data de Nascimento*:</label>
                    <input type="date" name="nascimento" id="datas" required>
                </div>
                <div class="box1dir">
                    <br>
                    <div class="inputBox">
                ...
                <div class="boxBotoes">
                    <input class="b2" type="reset" value="Voltar" id="botao" onclick="location.href='P11.MenuAdmin.php'">
