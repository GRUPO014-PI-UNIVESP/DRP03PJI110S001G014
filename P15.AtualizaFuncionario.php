<?php
    ...
    $consulta = "SELECT * FROM funcionario ORDER BY DEPARTAMENTO, NOME_FUNCIONARIO ASC";
...
<body>
    ...
    <div class="mainBox">
        <div class="topoLinha">
            ...
            <div class="coluna2">   
                <input class="b1" type="submit" id="" name="" value="Departamento" onclick="location.href='P15.AtualizaFuncionario.php'">
            </div> 
            <div class="coluna3">   
                <input class="b1" type="submit" id="" name="" value="Cargo"        onclick="location.href='P16.AtualizaFuncionario.php'"> 
            </div> 
            <div class="coluna4">   
                <input class="b2" type="reset" value="Voltar" id="botao" style="text-align:center" onclick="location.href='P11.MenuAdmin.php'">
            </div> 
        </div>
        <table>
            <thead>
                ...
                <tr>
                    ...
                    <td style="text-align:center; font-size:12px; width: 175px; height:45px;">
                        <input type="submit" id="editar" name="editar" value="Editar" 
                                onclick="location.href='P17.AtualizaFuncionario.php?id=<?php echo $dado['ID_FUNCIONARIO']?>'">
                        <input type="submit" id="excluir" name="excluir" value="Excluir"
                                onclick="location.href='P18.ExclusaoFuncionario.php?id=<?php echo $dado['ID_FUNCIONARIO']?>'">
                    </td>
                </tr> 
                <?php } ?>
            </tbody>
