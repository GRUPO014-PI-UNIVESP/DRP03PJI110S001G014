        ...
        <fieldset>
            <legend>Atividades do Laboratório</legend>
                ...
                <button class="seletor"
                    onclick="location.href='P21EntradaOrdemServico.php'">Abertura de Ordem de Serviço</button><br><br>
                <button class="seletor" 
                    onclick="location.href='P31RegistroAnalise.php'">Registro de Análises</button><br><br>
                <button class="seletor"
                    onclick="location.href='P41ReposicaoEstoque.php'">Reposição do Estoque de Reagentes</button><br><br>
                <button class="seletor"
                    onclick="location.href='P51RelatorioGQ.php'">Listas e Relatórios</button><br><br>
                <button class="seletor"
                    onclick="location.href='P05SenhaNova.php'">Alterar Senha de Usuário</button><br><br>
                <button class="seletor"
                    onclick="location.href='P71CadastroNovoReagente.php'">Cadastro de Novo Reagente</button><br><br>
                <button class="seletor"
                    onclick="location.href='P61CadastroAmostra.php'">Cadastro de Novas Amostras</button><br><br>
                <button class="seletor"
                    onclick="location.href='P81RetiradaEstoque.php'">Retirada de Reagentes do Estoque</button><br><br>
                <button class="sair"
