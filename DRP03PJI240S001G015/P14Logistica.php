<?php
    // Programa      : P14Logística.php
    // Funcionalidade: seletor para tarefas do departamento de logística 
...
<body>
  ...
  <div class="sidebarBottom">
    ...
    <!-- Área Principal -->
    <div class="main">
      <p style="text-align: center; font-size: 30px">Logística</p>

      <!-- Botões Seletores -->
      <div class="frame">       
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Entrada de Material</span></button>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Material Aguardando Análise</span></button><br><br>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span></span></button>
