<?php
    // Programa      : P15Producao.php
    // Funcionalidade: seletor para tarefas do departamento de produção 
...
<body>
  ...
  <div class="sidebarBottom">
    ...
    <!-- Área Principal -->
    <div class="main">
      <p style="text-align: center; font-size: 30px">Produção</p>

      <!-- Botões Seletores -->
      <div class="frame">       
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Registro de Pedido</span></button>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Cadastro de Novo Produto</span></button><br><br>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Cronograma de Produção</span></button>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Configurações da Infraestrutura</span></button><br><br>
        
        <button class="custom-btn btn-12" onclick="location.href=''">
          <span>Clique e acesse!</span><span>Produto Aguardando Análise</span></button>
