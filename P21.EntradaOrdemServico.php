...
<head>
    ...
    <link rel="stylesheet" href="CSS/style08.OrdemServico.css">
</head>
<style>
...
<body>
    ...
    <form action="" method="POST">
        <div class="mainBox">
            ...
            <br><br>
            <div class="box4dir">
                <input class="b2" type="reset" id="botao" value="voltar" onclick="location.href='P20.MenuGQ.php'">
                <input class="b2" type="reset" id="botao" value="sair"   onclick="location.href='P03.LogOut.php'">
            </div>
        </div>
    </form>
    <?php
    if(isset($_POST['codAmostra'])){
        ...
        if($contador == 0){
            ...
            header("Location: P22.DadosOrdemServico.php");
        }
    }
    ?>
</body>
