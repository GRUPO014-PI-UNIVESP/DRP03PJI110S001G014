<?php
    ...
    if($_SESSION['credencial'] < 3 && $_SESSION['departamento'] != 'ADMINISTRAÇÃO'){
        header('Location: P09.Mensagem.php');
    }
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <link rel="stylesheet" href="CSS/style02.MenuAdmin.css">
</head>
<style>
        ...
        <fieldset>
            <legend>Quadro de Funcionários</legend>
                ...
                <button class="seletor" 
                    onclick="location.href='P12.PrimeiroFormulario.php'">Cadastro de Funcionário</button><br><br>
                <button class="seletor"
                    onclick="location.href='P14.AtualizaFuncionario.php'">Atualização de Dados</button><br><br>
                <button class="seletor"
                    onclick="location.href='P08.HistoricoLogin.php'">Histórico de Login</button><br><br>
                <button class="seletor"
                    onclick="location.href='P05.SenhaNova.php'">Alterar Senha</button><br><br>
                <button class="sair"
                    onclick="location.href='P10.MenuAdministrador.php'">Voltar ao menu anterior</button><br><br>
        </fieldset>
