        ...
        <div class="principal">
            ...
            <fieldset>
                ...
                <div class="pLinha8R">
                    ...
                    <div class="pLinha9L">
                        <br>
                        <input type="reset" id="submit1" name="continua" value="Próximo Reagente" onclick="location.href='P32.RegistroAnalise.php'">
                    </div> 
                    <div class="pLinha9M">
                        <br>
                        <input type="reset" id="submit2" name="finaliza" value="Finalizar Ordem de Serviço" onclick="location.href='P35.RegistroAnalise.php'">
                    </div>
                    <div class="pLinha9R">
                        <br>
