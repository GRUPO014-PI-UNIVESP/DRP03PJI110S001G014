...
<body>   
    <div class="mainBox">
        <div class="esquerdaSup">
            <button class="seletor" onclick="location.href='P11.MenuAdmin.php'">Administração</button><br><br>
        </div>
        <div class="direitaSup">
            <button class="seletor" onclick="location.href='P20.MenuGQ.php'">Garantia de Qualidade</button><br><br>
        </div>
        <div class="espaco">
        </div>
        <div class="esquerdaInf">
            <button class="seletor" onclick="location.href='P91.MenuProd.php'">Produção</button><br><br>
        </div>
        <div class="direitaInf">
            <button class="seletor" onclick="location.href='P90.MenuLog.php'">Logística</button><br><br>
        </div>
        <div class="saida">
            <br><br>
            <button class="sair" onclick="location.href='P03.LogOut.php'">Sair do Sistema</button><br><br>
